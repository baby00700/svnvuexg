<template>
  <div class="login">
    ...
    <div class="header">
        <div class="logo"></div>
        <div class="sysname">学工智能服务平台-学生登录入口</div>
    </div>
    <div class="contenter">
      <div class="kshinput">
  ...
  methods: {
    ...
    loginin: function () {
      ...
      if (!reg.test(this.pwd)) {
        ...
        var that = this
        var usercode = '130628010404'
        var userpwd = '555555'
        var usertype = '0'
        var data0 = { openid: '456789', usercode: usercode, userpwd: userpwd, usertype: usertype }
        ...
        this.$ajax.post(url, qs.stringify(data0), {
          ...
          if (data.data !== null && data.data !== 'undefined' && data.data !== undefined) {
            ...
            if (isloginsuccess === true) {
              ...
              window.localStorage.setItem('usercode', '130628010404')
              window.localStorage.setItem('userpwd', '555555')
